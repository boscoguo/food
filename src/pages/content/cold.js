...
class ContentCold extends Component {
    render() {
        return (
            // render the certain element
...
export default connect(mapStateToProps, mapDispatchToProps)(ContentCold)